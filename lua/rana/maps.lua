...
-- Flutter config
keymap.set('', "fa", ":FlutterRun<CR>")
keymap.set('', 'fq', ':FlutterQuit<CR>')
keymap.set('', 'fd', ':FlutterDevices<CR>')
keymap.set('', 'fe', ':FlutterEmulators<CR>')
keymap.set('', 'fR', ':FlutterRestart<CR>')
keymap.set('', 'fo', ':FlutterOutlineOpen<CR>')
